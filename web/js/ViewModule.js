...
class ViewModule {
        ...
        content.innerHTML = 
            `<div class="login-container">
                <div class="imgcontainer">
                    <img src="Images/Account_enter.png" alt="Avatar" class="avatar">
                </div>
    ...
    showRegistrationForm() {
        ...
        content.innerHTML = 
            ...
            <div class="registration-heading">
                ...
                <h2 filter-content="S">REGISTRATION</h2>
            </div>
            ...
            <div class="wrap-input100 validate-input input-container" data-validate="Enter password">
                <img src="Images/password.jpg" class="input-img"></img>
        ...
        `<div id="adding-shoe" class="shoe-add-container">
            ...
            <div id="shoe-info" class="shoe-info-side">
                <div class="registration-heading">
                    ...
                    <h2 filter-content="S">ADD MODEL</h2>
                </div>
                <div class="mid-content">
                    <div class="pictures-select-container">
                        <label for="list pictures">LIST OF IMAGES:</label>
    ...
    showEditModel() {
        ...
        `<div class="shoe-edit-container">
            <div class="registration-heading">
                ...
                <h2 filter-content="S">EDIT MODEL</h2>
            </div>
                <div class="mid-content">
    ...
    showEditUser() {
        ...
        `<div class="user-edit-container">
            <div class="registration-heading">
                ...
                <h2 filter-content="S">EDIT USER</h2>
            </div>
            <div class="mid-content">
                <label for="list users">USERS LIST:</label>
                ...
                <div class="container-login100-form-btn">
                    <button class="login100-form-btn" type="submit" id="submit-edit-user">CHANGE</button>
                </div>
            </div>
        </div>`;
    ...
    showEditMyself() {
        ...
        <h2 filter-content="S">EDIT YOURSELF</h2>
    </div>
            <div class="mid-content">
                <div class="wrap-input100 validate-input" data-validate="Enter first name">
                    <input class="input100" type="text" id="user-first-name" name="user-firstNamer" placeholder="First name">
    ...
    showPurchaseForm() {
        ...
        <h2 filter-content="S">PURCHASE</h2>
    </div>
            <div class="mid-content">
                <label for="list models">MODEL LIST:</label>
                ...
                <div class="container-login100-form-btn">
                    <button class="login100-form-btn" type="submit" id="submit-purchase">BUY</button>
                </div>
            </div>
        </div>`;
    ...
    showAdminPanel() {
        ...
        <h2 filter-content="S">ADMIN PANEL</h2>
    </div>
            <div class="mid-content">
                <label for="list users">USERS LIST:</label>
                <select name="list users" id="list-users">
                ...
                <select name="list roles" id="list-roles">
                    <option value="SECONDADMIN">SECOND ADMINISTRATOR</option>
                    <option value="MANAGER">MANAGER</option>
                    <option value="USER">USER</option>
                </select>
                <div class="container-login100-form-btn">
                    <button class="login100-form-btn" type="submit" id="change-role">CHANGE</button>
                </div>
            </div>
        </div>`;
    ...
    showGain() {
        ...
        `<div id="gainCont" class="gain-container">
            <button id="allGainBtn">
                SHOW EARNINGS FOR ALL TIME
            </button>
            <div id="collapseExample">
                <p id="allGainTxt">&nbsp;</p>
            </div>
            <h3 id="monthHeading">THE STORE'S PROFIT FOR A CERTAIN MONTH</h3>
            <p id="gainForAMonth">
                &nbsp;
            </p>
            <div class="allGainContainers" style="font-size: 18px; font-family: Molot">
                <div id="firstColumn" style="width: 35em; text-align: center">
                    <div id="gainForSeptember" class="month list-group-item list-group-item-action list-group-item-warning">SEPTEMBER</div>
                    <div id="gainForOctober" class="month list-group-item list-group-item-action list-group-item-warning">OCTOBER</div>
                    <div id="gainForNovember" class="month list-group-item list-group-item-action list-group-item-warning">NOVEMBER</div>

                    <div id="gainForMarch" class="month list-group-item list-group-item-action list-group-item-info">MART</div>
                    <div id="gainForApril" class="month list-group-item list-group-item-action list-group-item-info">APRIL</div>
                    <div id="gainForMay" class="month list-group-item list-group-item-action list-group-item-info">MAY</div>
                </div>
                <div id="secondColumn" style="width: 35em; text-align: center">
                    <div id="gainForDecember" class="month list-group-item list-group-item-action list-group-item-primary">DECEMBER</div>
                    <div id="gainForJanuary" class="month list-group-item list-group-item-action list-group-item-primary">JANUARY</div>
                    <div id="gainForFebruary" class="month list-group-item list-group-item-action list-group-item-primary">FEBRUARY</div>

                    <div id="gainForJune" class="month list-group-item list-group-item-action list-group-item-danger">JUNE</div>
                    <div id="gainForJuly" class="month list-group-item list-group-item-action list-group-item-danger">JULY</div>
                    <div id="gainForAugust" class="month list-group-item list-group-item-action list-group-item-danger">AUGUST</div>
                </div>   
            </div>
        </div>`
