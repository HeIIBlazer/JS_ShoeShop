...
class UploadModule {
    insertListPictures() {
        ...
        promiseListPictures.then(response => response.json())
                ...
                .catch(error=>{
                    document.getElementById('info').innerHTML = 'SERVER ERROR insertListPictures: ' + error;
                    document.getElementById('info').style.opacity = '1';
                });
    }
    getPicture() {
        ...
        promiseListPictures.then(response => response.json())
            ...
            .catch(error => {
                document.getElementById('info').innerHTML = 'SERVER ERROR getPicture: ' + error;
                document.getElementById('info').style.opacity = '1';
            })
            .then(response => {
                try {
